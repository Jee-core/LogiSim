...
public class EventHandlers {
    ...
    private boolean saveConnectorToDatabase(int circuitId, Connector connector, int fromComponentId, int toComponentId) {
    ...
    private List<GateComponent> loadComponentsForCircuit(int circuitId) {
        ...
        try {
            ...
            ArrayList<Hashtable<String, String>> componentDataList = projectService.fetchComponentsForCircuit(circuitId);
    ...
    private void processAllComponents(ArrayList<Hashtable<String, String>> componentDataList, List<GateComponent> components) {
    ...
    private void processAllConnectors(ArrayList<Hashtable<String, String>> connectorDataList, List<Connector> connectors) {
