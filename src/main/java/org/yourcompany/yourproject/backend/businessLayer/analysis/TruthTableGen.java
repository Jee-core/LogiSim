...
public class TruthTableGen 
{
    ...
    /**
     * Generates truth table by directly simulating the circuit for all input combinations
     */
    ...
    public static class TruthTableRow 
    {
        ...
        public Map<String, Boolean> getInputs() { return new HashMap<>(inputs); }
        public Map<String, Boolean> getOutputs() { return new HashMap<>(outputs); }
        public boolean getInput(String name) { return inputs.getOrDefault(name, false); }
        public boolean getOutput(String name) { return outputs.getOrDefault(name, false); }
    }
