...
public class Circuit {
    ...
    public List<GateComponent> findCircuitInputs() {
        ...
        // If no clear input nodes found, use gates with no incoming internal
        // connections
        if (inputs.isEmpty()) {
            for (GateComponent gate : gates) {
    ...
    public List<GateComponent> findCircuitOutputs() {
        ...
        // If no clear output nodes found, use gates with no outgoing internal
        // connections
        if (outputs.isEmpty()) {
            for (GateComponent gate : gates) {
    ...
    public void displayCircuitInfo() {
        ...
        for (GateComponent gate : gates) {
            if (gate instanceof LED) {
                LED led = (LED) gate;
                System.out.println(
                        "  LED " + gate.getId() + " at " + gate.getPosition() + " - " + (led.isLit() ? "LIT" : "OFF"));
            } else {
