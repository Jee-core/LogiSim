...
public class Connector 
{
    ...
    public Connector(Connector other, GateComponent newFrom, GateComponent newTo) 
    {
        ...
        if (newFrom != null) newFrom.attachOutputConnector(sourcePort, this);
        if (newTo != null) newTo.attachInputConnector(destPort, this);
    }
    ...
    public void recalculateWirePositions() 
    {
        if (sourceGate != null && sourcePort >= 0) 
        {
            ...
            {
                org.yourcompany.yourproject.Frontend.DrawGates uiGate = 
                    (org.yourcompany.yourproject.Frontend.DrawGates) fromGateUI;
        ...
        if (destGate != null && destPort >= 0) {
            ...
            {
                org.yourcompany.yourproject.Frontend.DrawGates uiGate = 
                    (org.yourcompany.yourproject.Frontend.DrawGates) toGateUI;
    ...
    public Object getToUI() { return toGateUI; }
    ...
    public GateComponent getFromGate() { return sourceGate; }
    ...
    public GateComponent getToGate() { return destGate; }
    ...
    public int getSourcePortIndex() { return sourcePort; }
    ...
    public int getDestinationPortIndex() { return destPort; }
    ...
    public Boolean getSignalValue() { return signalVal; }
    public void setSignalValue(Boolean signalValue) { this.signalVal = signalValue; }
